...
# for i in /Users/kprovost/Documents/Postdoc_Working/JY_project/ANNOTATED/*annot.csv; do python3 "/Users/kprovost/Documents/GitHub/bioacoustics/tweetynet_output_to_raven.py" $i 10000 500 1; gzip $i; done;
